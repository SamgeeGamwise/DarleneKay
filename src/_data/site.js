...
module.exports = {
  ...
  reviews: [
    { reviewer: "Dina Eledge", stars: 5, text: "We had a wonderful experience hiring this company to paint several rooms in our townhome. The owners were knowledgeable and provided excellent customer service and the painters were very talented. The project was completed on time, and we couldn't be happier." },
    { reviewer: "Abhi", stars: 5, text: "Great experience working with Roy to get our house exterior painted. Clear communications, great expectations setting and quick & on time job completion. The quality of the work was excellent and we are very happy." },
    { reviewer: "Philip Tussing", stars: 5, text: "The project was handled with complete professionalism. They did exactly what work was quoted for exactly what was requested for that work. Very clean job site and the men were considerate and attentive to our needs. I would use these guys again and refer them to all my friends and neighbors - Thanks again guys." },
    { reviewer: "Madeleine Smith", stars: 5, text: "The Thomases are so professional, kind, and most importantly, amazingly skilled at what they do. We moved into a new house and they matched existing paint perfectly and absolutely transformed our baseboards. Perfect lines, perfect color matching, just amazing job. We will absolutely use them for other painting jobs. They have so much integrity. It is so nice to know that I can trust their experience, pricing, and work quality." },
    { reviewer: "Russ Watterson", stars: 5, text: "Hands down the best painting company I’ve ever had the pleasure of working with. Roy and his crew did outstanding work painting the interior of our home. They showed up on time, left on time, and did high quality work. Roy is an outstanding communicator and made sure that we were happy with every detail of the job. I’ve hired this company on various occasions and always had a good experience." },
